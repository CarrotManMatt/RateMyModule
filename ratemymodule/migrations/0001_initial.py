# Generated by Django 4.2.10 on 2024-02-16 20:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solved', models.BooleanField(default=False, verbose_name='Is_Solved')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='report_set', to='ratemymodule.post', verbose_name='Post')),
                ('reporter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='made_report_set', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'verbose_name': 'Report',
            },
